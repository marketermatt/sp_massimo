		...
		<form method="post" enctype="multipart/form-data" id="sp-panel-form">	
            ...
            <div id="sp-main-tabs">
                ...
                <div class="top-nav">
					...
					<ul class="tabs">
					<li class="License">
					<a href="<?php echo esc_url( admin_url( 'index.php?page=api_manager_theme_massimo_dashboard' ) );?>" title="<?php esc_attr_e( 'License', 'sp-theme' ); ?>"><?php _e( 'License', 'sp-theme' ); ?></a>
					</li>
					</ul>
					</div>
                    </ul>
