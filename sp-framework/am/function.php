...
class API_Manager_theme_Example {
	...
	public static function am_theme_example_inactive_notice() { ?>
		...
		<div id="message" class="error">
			<p><?php printf( __( 'The API Manager Theme Example API License Key has not been activated, so the theme is inactive! %sClick here%s to activate the license key and the theme.', 'api-manager-example' ), '<a href="' . esc_url( admin_url( 'index.php?page=api_manager_theme_massimo_dashboard' ) ) . '">', '</a>' ); ?></p>
		</div>
		<?php
	}
