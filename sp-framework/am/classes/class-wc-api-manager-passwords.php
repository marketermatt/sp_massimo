...
class API_Manager_Massimo_theme_Password_Management {
	...
	private function rand( $min = 0, $max = 0 ) {
		...
		// Some misconfigured 32bit environments (Entropy PHP, for massimo) truncate integers larger than PHP_INT_MAX to PHP_INT_MAX rather than overflowing them to floats.
