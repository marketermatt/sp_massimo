...
/**
 * Function that displays the meta icons shown in header like cart/search
 * @access public
 * @since 3.0
 * @return html | $output
 */
function sp_display_header_meta_icons() {
	...
	if ( sp_get_option( 'display_search', 'is', 'on' ) )
		$output .= '<a href="#" title="' . esc_attr__( 'Search', 'sp-theme') . '" class="search-icon-button sp-tooltip" data-toggle="tooltip" data-placement="top"></a>' . PHP_EOL;
