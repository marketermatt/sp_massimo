...
<div id="wrap-all">
	<?php sp_woo_exists() ? sp_display_wishlist_compare_icons() : ''; ?>
	...
	<header id="main-header" class="clearfix">
		...
		<div id="brand-container" class="clearfix">
			...
			<div class="<?php echo esc_attr( $container_class ); ?>">
				<div class="row">
					<div class="logo-column <?php echo sp_column_css( '12', '', '', '12' ); ?>">
						<!--LOGO-->
		...
		<div class="nav-wrap">
			<div class="container">
				...
				<div class="row">
					<div class="<?php echo sp_column_css( '', '12', '', '10' ); ?>">
						<!--PRIMARY MENU-->
					...
					<div class="meta-icons-column <?php echo sp_column_css( '', '12', '', '2' ); ?>">
